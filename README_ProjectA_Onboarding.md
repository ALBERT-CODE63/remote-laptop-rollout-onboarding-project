...
- Create onboarding KB, feedback form, and ticket documentation.

---

## 🧩 Tools & Technologies
- 🪟 **Windows 11 / macOS / Linux** (VMs on VirtualBox)
- 🧩 **JumpCloud MDM**
...
setup_logs/ — Notes from VM imaging and configuration  
...
- [x] Onboarding Call Simulation Transcript  
...
## 📝 Feedback Form
📋 [Submit Feedback Here](https://forms.gle/YOUR_GOOGLE_FORM_LINK)
